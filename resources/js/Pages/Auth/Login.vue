...
<template>
    <AppLayout>
        <Head :title="isSignUp ? 'Registro' : 'Iniciar Sesión'" />
        ...
        <div class="min-h-[400px] flex pt-4 pb-12 mb-12">
            ...
            <div class="bg-[#F9FAFB] shadow-lg rounded-xl p-6 border border-gray-100">
                <div class="mx-auto w-full max-w-sm lg:w-96 px-6">
                    <!-- Logo/Título -->
                    <div class="mb-8">
                    ...
                    <div class="mb-6">
                        <p class="text-center text-sm text-gray-600 mb-4">
                            {{ isSignUp ? 'Regístrate' : 'Inicia sesión' }} usando redes sociales
                        </p>
                    ...
                    <form v-if="!isSignUp" @submit.prevent="submitLogin" class="space-y-4">
                        ...
                        <button
                            ...
                            :class="{ 'opacity-75 cursor-not-allowed': loginForm.processing }"
                            :disabled="loginForm.processing"
                        >
                            <span v-if="loginForm.processing">Iniciando sesión...</span>
                    ...
                    <form v-else @submit.prevent="submitRegister" class="space-y-4">
                        ...
                        <button
                            type="submit"
                            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                            :class="{ 'opacity-75 cursor-not-allowed': registerForm.processing }"
                            :disabled="registerForm.processing"
                        >
                            <span v-if="registerForm.processing">Creando cuenta...</span>
            ...
            <div class="hidden lg:flex lg:flex-1 bg-gradient-to-br from-indigo-500 to-indigo-700 relative overflow-hidden shadow-md">
                ...
                <div class="relative z-10 flex flex-col justify-center px-12 xl:px-16 text-white">
                    <div class="max-w-md">
                        <h2 class="text-4xl xl:text-5xl font-bold mb-6">
                            {{ isSignUp ? '¡Bienvenido!' : '¿Nuevo aquí?' }}
                        </h2>
                        <p class="text-lg xl:text-xl text-indigo-100 mb-8 leading-relaxed">
                            {{ isSignUp 
                                ...
                                : 'Únete a nuestra comunidad y descubre una gran cantidad de nuevas oportunidades en moda.'
                            }}
                        </p>
                        <button
                            @click="toggleSignUp"
