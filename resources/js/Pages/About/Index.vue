    ...
    <div class="w-6 h-10 border-2 border-white rounded-full p-1">
      ...
      <section id="manifesto" class="py-24 bg-black text-white relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
          <div class="absolute top-20 left-20 w-64 h-64 bg-indigo-500 rounded-full blur-3xl"></div>
          <div class="absolute bottom-20 right-20 w-96 h-96 bg-purple-500 rounded-full blur-3xl"></div>
        </div>
        
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div class="text-center mb-20">
            <h2 class="text-4xl md:text-6xl font-black mb-8 animate-fade-in-up">
              NUESTRO <span class="gradient-text-hero">MANIFIESTO</span>
            </h2>
            <div class="w-24 h-1 bg-gradient-to-r from-indigo-500 to-purple-500 mx-auto mb-12 animate-scale-in delay-300"></div>
          </div>
          ...
          <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8 animate-fade-in-left delay-400">
              <div class="text-lg md:text-xl leading-relaxed space-y-6">
                <p class="text-gray-300">
                  ...
                  La moda no es solo lo que llevas puesto. Es una declaración, una revolución silenciosa, una forma de arte que camina por las calles.
                  <span class="text-2xl font-bold text-white">"</span>
                </p>
                <p class="text-gray-300">
                  En TrendClothes creemos que cada persona merece vestir piezas que no solo luzcan extraordinarias, sino que cuenten su historia única. No seguimos tendencias, las creamos. No copiamos estilos, los reimaginamos.
                </p>
                <p class="text-gray-300">
                  Nuestro compromiso va más allá de la estética: es un compromiso con la calidad, la sostenibilidad y la innovación que respeta tanto a quien lo lleva como al planeta que habitamos.
                </p>
              </div>
              ...
              <div class="flex space-x-4 pt-8">
                <div class="text-center">
                  ...
                  <div class="text-sm text-gray-400 uppercase tracking-wide">Años Innovando</div>
                </div>
                <div class="w-px bg-gray-700"></div>
                <div class="text-center">
                  <div class="text-3xl font-black text-purple-400">15K+</div>
                  <div class="text-sm text-gray-400 uppercase tracking-wide">Clientes Únicos</div>
                </div>
                <div class="w-px bg-gray-700"></div>
                <div class="text-center">
                  <div class="text-3xl font-black text-pink-400">∞</div>
                  <div class="text-sm text-gray-400 uppercase tracking-wide">Posibilidades</div>
                </div>
              </div>
            </div>
            ...
            <div class="relative animate-fade-in-right delay-600">
              <div class="aspect-square rounded-3xl overflow-hidden relative group">
                ...
                >
                <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent group-hover:from-black/70 transition-all duration-700"></div>
                <div class="absolute bottom-8 left-8 right-8">
                  <p class="text-white font-bold text-lg">Cada pieza, una obra de arte</p>
                </div>
              </div>
              <div class="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full animate-pulse-glow"></div>
            </div>
          </div>
        </div>
      </section>
...
<section id="our-journey" class="py-24 bg-white relative">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-20">
      <span class="text-sm font-bold tracking-widest text-indigo-600 uppercase animate-fade-in-up">Nuestra Historia</span>
      <h2 class="text-4xl md:text-5xl font-black text-gray-900 mt-4 mb-8 animate-fade-in-up delay-200">
        Más que ropa, <span class="gradient-text">una revolución</span>
      </h2>
      <p class="text-xl text-gray-600 max-w-3xl mx-auto animate-fade-in-up delay-400">
        TrendClothes nace con la misión de transformar la forma en que entendemos y vivimos la moda.
      </p>
    </div>
    ...
    <div class="relative">
      ...
      <div class="space-y-24">
        <!-- 2020 -->
        <div class="relative flex items-center animate-fade-in-left delay-500">
          <div class="flex-1 pr-8 text-right">
            <div class="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-indigo-500">
              <h3 class="text-2xl font-bold text-gray-900 mb-4">2020 – La Idea</h3>
              <p class="text-gray-600 mb-4">
                En plena pandemia, tres jóvenes diseñadores decidieron apostar por una moda que combinara estilo, conciencia y cercanía digital.
              </p>
              <div class="text-sm text-indigo-600 font-semibold">Proyecto incubado en casa | 100% digital desde el día uno</div>
            </div>
          </div>
        ...
        <!-- 2022 -->
        <div class="relative flex items-center animate-fade-in-right delay-600">
          ...
          <div class="flex-1 pl-8">
            <div class="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-purple-500">
              <h3 class="text-2xl font-bold text-gray-900 mb-4">2022 – Primer salto</h3>
              <p class="text-gray-600 mb-4">
                Abrimos nuestra tienda online, con envíos en 24h y una experiencia de usuario centrada en el detalle. La comunidad crece y se consolida.
              </p>
              <div class="text-sm text-purple-600 font-semibold">+3.000 pedidos en 6 meses | 200 productos únicos</div>
            </div>
          </div>
        </div>

        <!-- 2024 -->
        <div class="relative flex items-center animate-fade-in-left delay-700">
          <div class="flex-1 pr-8 text-right">
            <div class="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-green-500">
              <h3 class="text-2xl font-bold text-gray-900 mb-4">2024 – Moda consciente</h3>
              <p class="text-gray-600 mb-4">
        ...
        <!-- 2025 -->
        <div class="relative flex items-center animate-fade-in-right delay-800">
          <div class="flex-1 pr-8">
            <img 
          ...
          <div class="flex-1 pl-8">
            <div class="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-indigo-500">
              <h3 class="text-2xl font-bold text-gray-900 mb-4">2025 – Comunidad global</h3>
              <p class="text-gray-600 mb-4">
                Presentamos nuestra primera flagship store en Barcelona y la app oficial de TrendClothes. Más cerca de nuestra comunidad, más allá de fronteras.
              </p>
              <div class="text-sm text-indigo-600 font-semibold">+18.000 clientes | 12 países | 1 visión: vestir con propósito</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <section class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Innovación -->
            <div class="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-300">
              ...
              <p class="text-gray-600 leading-relaxed">
                Constantemente exploramos nuevas fronteras en diseño, materiales y tecnología para ofrecer experiencias únicas y revolucionarias.
              </p>
            </div>

            <!-- Sostenibilidad -->
            <div class="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-400">
              ...
              <h3 class="text-2xl font-bold text-gray-900 mb-4">Sostenibilidad</h3>
              <p class="text-gray-600 leading-relaxed">
                Nuestro compromiso con el planeta es inquebrantable. Cada decisión que tomamos considera su impacto ambiental y social.
              </p>
            </div>

            <!-- Autenticidad -->
            <div class="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-500">
              ...
              <h3 class="text-2xl font-bold text-gray-900 mb-4">Autenticidad</h3>
              <p class="text-gray-600 leading-relaxed">
                Celebramos la individualidad y creamos piezas que permiten a cada persona expresar su verdadera esencia sin compromisos.
              </p>
            </div>

            <!-- Calidad -->
            <div class="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-600">
              <div class="w-16 h-16 bg-gradient-to-r from-rose-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
              </div>
              <h3 class="text-2xl font-bold text-gray-900 mb-4">Calidad</h3>
              <p class="text-gray-600 leading-relaxed">
                Cada hilo, cada costura, cada detalle es cuidadosamente elaborado para crear piezas que trascienden el tiempo y las tendencias.
              </p>
            </div>

            <!-- Comunidad -->
            <div class="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-700">
              ...
              <h3 class="text-2xl font-bold text-gray-900 mb-4">Comunidad</h3>
              <p class="text-gray-600 leading-relaxed">
                Construimos más que productos, construimos conexiones. Nuestra comunidad es el corazón de todo lo que hacemos.
              </p>
            </div>

            <!-- Creatividad -->
            <div class="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-800">
              ...
              <h3 class="text-2xl font-bold text-gray-900 mb-4">Creatividad</h3>
              <p class="text-gray-600 leading-relaxed">
                La creatividad sin límites es nuestro motor. Cada colección es una nueva oportunidad de sorprender y emocionar.
              </p>
            </div>
          </div>
        </div>
