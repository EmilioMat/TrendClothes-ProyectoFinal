...
const addFilterParamsToPaginationLink = (url) => {
    ...
    selectedFilters.value.colors.forEach((color) =>
        params.append("colors[]", color)
    );
    selectedFilters.value.genders.forEach((gender) =>
        params.append("genders[]", gender)
    );
    selectedFilters.value.sizes.forEach((size) =>
        params.append("sizes[]", size)
    );
    selectedFilters.value.brands.forEach((brand) =>
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    stroke-width="2"
                                    d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586l-5 5V17a1 1 0 01-.293.707l-2 2A1 1 0 0113 19v-5.414l-5-5V4z"
                                />
                            </svg>
                            <svg
                                v-else
                        ...
                        >
                            ...
                            <div class="mb-6 border-b border-gray-200 pb-4">
                                ...
                                >
                                    ...
                                    <svg
                                        :class="{
                                            'rotate-180': filterSections.price,
                                        }"
                            ...
                            <div
                                ...
                                v-if="filterValues.colors.length"
                            >
                                <button
                                    @click="
                                        filterSections.colors =
                                            !filterSections.colors
                                    "
                                    class="flex justify-between items-center w-full text-lg font-medium text-gray-800 mb-3 hover:text-indigo-600 transition-colors"
                                >
                                    ...
                                    <svg
                                        :class="{
                                            'rotate-180': filterSections.colors,
                                        }"
                                        class="w-5 h-5 transition-transform duration-300"
                                        fill="none"
                                        stroke="currentColor"
                                ...
                                <div
                                    v-show="filterSections.colors"
                                    class="space-y-3 transition-all duration-300"
                                >
                                    <div
                                        v-for="color in filterValues.colors"
                                        :key="color"
                                    ...
                                    >
                                        ...
                                        >
                                            <span
                                                class="w-5 h-5 mr-3 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-indigo-500"
                                                :style="{
                                            ...
                                            >
                                                <span
                                                    v-if="
                                                        selectedFilters.colors.includes(
                                                            color
                                                        )
                                                    "
                                                    class="w-3 h-3 rounded-full bg-white border-2 border-indigo-600"
                                                ></span>
                                            </span>
                                            <span
                                                class="text-sm text-gray-700 capitalize group-hover:text-indigo-600 transition-colors"
                                                >{{ color }}</span
                                            >
                                        </label>
                                    </div>
                            ...
                            <div
                                class="mb-6 border-b border-gray-200 pb-4"
                                v-if="filterValues.genders.length"
                            >
                                <button
                                    @click="
                                        filterSections.genders =
                                            !filterSections.genders
                                    "
                                    class="flex justify-between items-center w-full text-lg font-medium text-gray-800 mb-3 hover:text-indigo-600 transition-colors"
                                >
                                ...
                                <div
                                    v-show="filterSections.genders"
                                    class="space-y-3 transition-all duration-300"
                                >
                                    <div
                                        v-for="gender in filterValues.genders"
                                        :key="gender"
                                        class="flex items-center"
                                    >
                                        <input
                                        ...
                                        >
                                            <span
                                                class="w-5 h-5 mr-3 rounded border border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-indigo-500"
                                            >
                                                <span
                                                    v-if="
                                                        selectedFilters.genders.includes(
                                                            gender
                                                        )
                                                    "
                                                    class="w-3 h-3 rounded bg-indigo-600"
                                                ></span>
                                            </span>
                                            <span
                                                class="text-sm text-gray-700 capitalize group-hover:text-indigo-600 transition-colors"
                            ...
                            <div
                                class="mb-6 border-b border-gray-200 pb-4"
                                v-if="filterValues.sizes.length"
                            >
                                <button
                                    @click="
                                        filterSections.sizes =
                                            !filterSections.sizes
                                    "
                                    class="flex justify-between items-center w-full text-lg font-medium text-gray-800 mb-3 hover:text-indigo-600 transition-colors"
                                >
                                    ...
                                    <svg
                                        :class="{
                                            'rotate-180': filterSections.sizes,
                                        }"
                                        class="w-5 h-5 transition-transform duration-300"
                                        fill="none"
                                        stroke="currentColor"
                                ...
                                <div
                                    v-show="filterSections.sizes"
                                    class="grid grid-cols-3 gap-3 transition-all duration-300"
                                >
                                    <div
                                        v-for="(
                                            sizeName, sizeId
                                        ) in filterValues.sizes"
                                        :key="sizeId"
                                        class="flex items-center"
                                    >
                                        <input
                                            ...
                                            <div
                                                ...
                                                :class="{
                                                    'bg-indigo-50 border-indigo-500 text-indigo-600':
                                                        selectedFilters.sizes.includes(
                                                            sizeId
                                                        ),
                                                }"
                                            >
                            ...
                            <div
                                class="mb-6 border-b border-gray-200 pb-4"
                                v-if="filterValues.brands.length"
                            >
                                <button
                                    @click="
                                        filterSections.brands =
                                            !filterSections.brands
                                    "
                                    class="flex justify-between items-center w-full text-lg font-medium text-gray-800 mb-3 hover:text-indigo-600 transition-colors"
                                >
                                    ...
                                    <svg
                                        :class="{
                                            'rotate-180': filterSections.brands,
                                        }"
                                        class="w-5 h-5 transition-transform duration-300"
                                        fill="none"
                                        stroke="currentColor"
                                ...
                                <div
                                    v-show="filterSections.brands"
                                    class="space-y-3 transition-all duration-300"
                                >
                                    <div
                                        v-for="brand in filterValues.brands"
                                        :key="brand"
                                        class="flex items-center"
                                    >
                                        <input
                                        ...
                                        >
                                            ...
                                            <span
                                                class="text-sm text-gray-700 group-hover:text-indigo-600 transition-colors"
                                                >{{ brand }}</span
                                            >
                                        </label>
                                    </div>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="mb-10">
                            <div
                                ...
                                style="
                                    background-image: url('https://i8.amplience.net/i/jpl/fredhopper-1130x511-mixed-15-449a1eb08a749fea9b06cbf819a2f8e7?fmt=auto');
                                    width: 100%;
                                    height: 240px;
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <el-icon
                                                :size="48"
                                                class="rounded-full p-4 bg-white hover:bg-gray-200 transition-colors"
                                            >
                                                <View />
                                            </el-icon>
                                        </Link>
                                ...
                                <div
                                    class="pt-4 pb-2 px-2 flex flex-col justify-between"
                                >
                                    <span
                            ...
                            <div class="flex flex-wrap justify-center gap-2">
                                ...
                                >
                                    ...
                                    <Link
                                        ...
                                        :href="
                                            addFilterParamsToPaginationLink(
                                                link.url
                                            )
                                        "
                                    >
