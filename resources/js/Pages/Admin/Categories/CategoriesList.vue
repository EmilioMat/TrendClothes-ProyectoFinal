...
<template>
    <section class="p-2 sm:p-5">
        ...
        <el-dialog
            ...
            class="custom-dialog"
        >
            <form @submit.prevent="saveCategory" class="grid grid-cols-1 gap-3 sm:gap-6">
                <!-- Nombre -->
                <div>
        ...
        <div class="mx-auto max-w-screen-xl px-2 sm:px-4 lg:px-12">
            ...
            >
                <div
                    class="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0 sm:space-x-4 p-3 sm:p-4"
                >
                    ...
                    >
                        ...
                        >
                            <tr>
                                ...
                                <th scope="col" class="px-2 sm:px-4 py-2 sm:py-3">Imagen</th>
                                <th scope="col" class="px-2 sm:px-4 py-2 sm:py-3">
                            ...
                            >
                                ...
                                <td class="px-2 sm:px-4 py-2">
                                    <img
                                        ...
                                        class="h-8 sm:h-10 w-8 sm:w-10 object-cover rounded"
                                        @error="
                                            console.log(
                ...
                <nav
                    class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-2 sm:space-y-0 p-3 sm:p-4"
