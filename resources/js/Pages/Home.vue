    ...
    <nav :class="{ 'scrolled': isScrolled }" class="fixed top-0 left-0 w-full z-10 transition-all duration-300">
      ...
      <div v-if="mobileMenuOpen" class="md:hidden fixed inset-0 z-50">
        <div 
          ...
          style="border: 0; bottom: 0; height: 100%; left: 0; overflow-y: scroll; padding: 0; right: 20px; width: calc(100% - 20px);"
        >
    ...
    <main class="bg-white">
      ...
      <div class="relative overflow-hidden w-full h-[600px] md:h-[800px]">
        <div class="flex transition-transform duration-500 h-full" :style="{ transform: `translateX(-${currentSlide * 100}%)` }">
          <div v-for="(slide, index) in slides" :key="index" class="min-w-full h-full flex items-center justify-center relative">
            <picture>
            ...
            <div class="absolute text-center text-white px-4 hidden md:block" style="top: 50%; left: 50%; transform: translate(-50%, -50%);">
              <h1 v-if="index === 0" class="text-4xl md:text-6xl font-bold text-white mb-6 animate-fade-in">
                {{ slide.title }}
              </h1>
              <span v-else class="text-4xl md:text-6xl font-bold text-white mb-6 animate-fade-in">
                {{ slide.title }}
              </span>
      ...
      <div class="w-full px-4 sm:px-6 lg:px-8 py-12">
        <div class="relative text-center">
          <div class="flex justify-center items-center px-6 py-3 bg-gradient-to-r from-indigo-600/20 to-emerald-500/20 backdrop-blur-lg rounded-full border border-white/10 mb-6 mx-auto w-max">
            ...
            <h2 class="text-indigo-600 font-semibold text-sm tracking-wider">EXPLORA</h2>
          </div>
          ...
          <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4 text-center mb-10">
...
>
      ...
      <div class="relative overflow-hidden py-24 mb-12">
        ...
        <div class="absolute inset-0">
          <div class="absolute bottom-1/4 left-1/2 w-96 h-96 bg-white-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse delay-500"></div>
        </div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Main Header -->
          <div class="text-center mb-20">
            <div class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600/20 to-emerald-500/20 backdrop-blur-lg rounded-full border border-white/10 mb-6">
              <svg class="w-5 h-5 text-indigo-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <h2 class="text-indigo-600 font-semibold text-sm tracking-wider">TEMPORADA OTOÑO 2025</h2>
            </div>
            ...
            <p class="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed">
              Descubre las piezas más exclusivas de la temporada. Cada prenda cuenta una historia, 
              cada look marca una diferencia.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div class="relative group">
              <div class="absolute -inset-4 bg-gradient-to-r from-indigo-600 via-emerald-500 to-indigo-300 rounded-3xl blur-lg opacity-20 group-hover:opacity-40 transition-opacity duration-500"></div>
              <div class="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/30">
                <div class="absolute top-6 right-6 z-10">
                  <span class="px-4 py-2 bg-gradient-to-r from-emerald-500 to-indigo-600 text-white text-xs font-bold rounded-full animate-pulse">
                    TRENDING #1
                  </span>
                </div>
                
                <div class="aspect-square rounded-2xl overflow-hidden mb-6 bg-gradient-to-br from-gray-200 to-gray-300">
                  <img 
                ...
                <div class="text-center">
                  <span class="text-2xl font-bold text-black mb-2">{{ featuredProduct.name }}</span>
                  <p class="text-gray-500 mb-4">{{ featuredProduct.description }}</p>
                  <div class="flex items-center justify-center space-x-3 mb-6">
                    <span class="text-lg text-gray-500 line-through">{{ formatPrice(featuredProduct.originalPrice) }}</span>
                    <span class="text-3xl font-black text-indigo-300">{{ formatPrice(featuredProduct.discountedPrice) }}</span>
                    <span class="px-2 py-1 bg-emerald-500 text-white text-xs font-bold rounded">
                      -{{ Math.round((1 - featuredProduct.discountedPrice / featuredProduct.originalPrice) * 100) }}%
                    </span>
                  </div>
                  <Link 
            ...
            <div class="space-y-8">
              ...
              <div class="flex items-center space-x-6 group cursor-pointer">
                <div class="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <div class="flex-1">
                  <span class="text-xl font-bold text-black mb-2">Envío Express Gratis</span>
                  <p class="text-gray-500">Recibe tu pedido en 24h sin coste adicional</p>
                </div>
              ...
              <!-- Feature 2 -->
              <div class="flex items-center space-x-6 group cursor-pointer">
                <div class="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-emerald-500 to-indigo-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div class="flex-1">
                  <span class="text-xl font-bold text-black mb-2">Garantía Total</span>
                  <p class="text-gray-500">30 días para cambios y devoluciones</p>
                </div>
                <div class="opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <!-- Feature 3 -->
              <div class="flex items-center space-x-6 group cursor-pointer">
                <div class="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-gray-400 to-indigo-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                  </svg>
                </div>
                <div class="flex-1">
                  <span class="text-xl font-bold text-black mb-2">Precio Justo</span>
                  <p class="text-gray-500">La mejor calidad al precio más competitivo</p>
                </div>
                <div class="opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div class="pt-8">
                <Link
                  :href="route('categories.show', { category: 'sudaderas' })"
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12 border-t border-white/10">
            <div class="text-center group cursor-pointer">
              <div class="text-4xl font-black text-indigo-600 mb-2 group-hover:scale-110 transition-transform">50K+</div>
              <div class="text-gray-500 text-sm">Clientes Felices</div>
            </div>
            <div class="text-center group cursor-pointer">
              <div class="text-4xl font-black text-emerald-600 mb-2 group-hover:scale-110 transition-transform">1K+</div>
              <div class="text-gray-500 text-sm">Productos Únicos</div>
            </div>
            <div class="text-center group cursor-pointer">
              <div class="text-4xl font-black text-indigo-600 mb-2 group-hover:scale-110 transition-transform">24/7</div>
              <div class="text-gray-500 text-sm">Soporte Premium</div>
            </div>
            <div class="text-center group cursor-pointer">
              <div class="text-4xl font-black text-gray-600 mb-2 group-hover:scale-110 transition-transform">5★</div>
      ...
      <div class="w-full px-4 sm:px-6 lg:px-8 py-8 ">
        <div class="relative text-center">
          ...
          <h3 class="text-6xl font-black text-black mb-10 leading-tight ">
            <span>Nuestras </span>
            <span class="bg-gradient-to-r from-indigo-600 via-emerald-500 to-indigo-300 bg-clip-text text-transparent">
              marcas
            </span>
...
// Define props for the featured product
defineProps({
  featuredProduct: {
    type: Object,
    default: () => ({
...
const messages = [
  ...
  { text: 'TEMPORADA DE CHAQUETAS FINAS', link: route('categories.index') + '#categories', cta: 'COMPRAR AHORA' },
  { text: 'CAMISETAS THE NORTH FACE', link: route('categories.index') + '#categories', cta: 'COMIENZA TU AVENTURA' },
];
...
// Brand Slider
const brands = [
  { name: 'Nike', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/nike.svg?w=1440&q=75' },
  { name: 'adidas', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/adidas.svg?w=1440&q=75' },
  { name: 'Puma', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/puma.svg?w=1440&q=75' },
  { name: 'Fila', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/fila.svg?w=1440&q=75' },
  { name: 'Under Armour', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/under-armour.svg?w=1440&q=75' },
  { name: 'The North Face', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/tnf.svg?w=1440&q=75' },
  { name: 'New Balance', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/new-balance.svg?w=1440&q=75' },
  { name: 'Converse', target: '_self', label: 'upper_brand', date: '200624', src: 'https://resize.sprintercdn.com/s/storefront/common/logos/brands/new/converse.svg?w=1440&q=75' },
];
...
const categories = computed(() => page.props.categories || [
  { id: 1, name: 'Pantalones', image: '/images/Page-Home/pantalones.webp' },
  { id: 2, name: 'Sudaderas', image: '/images/Page-Home/sudaderas.webp' },
  { id: 3, name: 'Camisetas', image: '/images/Page-Home/camisetas.webp' },
]);
