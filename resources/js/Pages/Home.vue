                    ...
                    <div class="flex">
                        ...
                        >
                            <Link
                                href="/"
                                :class="{
                                    'border-indigo-500 text-gray-900': true,
                                    'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700': false,
                                }"
        ...
        <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-6 sm:px-0">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Descubre las últimas tendencias de moda y ropa de alta
                    calidad para todos.
                </p>
                <div
                ...
                >
                    <div
                        v-for="category in ['Hombre', 'Mujer', 'Unisex']"
                        :key="category"
                    ...
                    >
                        <div class="p-6">
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                Explora nuestra amplia selección de ropa para
